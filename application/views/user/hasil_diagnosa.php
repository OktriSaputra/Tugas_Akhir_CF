    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            <?php if(sizeof($listPenyakit)>0) { ?>
                <p>
                    Berdasarkan gejalanya,   <b><?php echo $listPenyakit[0]['nama'];?></b> dengan tingkat kepercayaan <b><?php echo $listPenyakit[0]['kepercayaan'];?> %</b><br/>
                    <?php echo $listPenyakit[0]['keterangan'];?>. <p style="font-style: bold; color: red; font-size: 13px;">* 
                </p>
            <?php }else{?>
                <p>
