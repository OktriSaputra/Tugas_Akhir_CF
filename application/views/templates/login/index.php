...
<html lang="en">
<head>
	<title>Selamat Datang Di Sistem Diagnosa Penyakit Asma</title>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="<?php echo base_url() ?>assets/templatelogin/images/icons/favicon.ico"/>
<!--===============================================================================================-->
...
<header class="default-header">
				<nav class="navbar navbar-expand-lg  navbar-light">
					<div class="container">
						  <a class="navbar-brand" href="diagnosa.php">
						  <li><a href="<?php echo site_url() ?>/welcome/diagnosa"><img src="<?php echo base_url() ?>assets/templateuser/img/logo.png" alt="welcome/diagnosa"></li></a>
						  	<li><a href="<?php echo site_url() ?>/welcome/diagnosa"><img src="<?php echo base_url() ?>assets/templateuser/img/logo-1.png" alt="welcome/diagnosa"></li></a>
						  </a>
						  ...
						  <div class="collapse navbar-collapse justify-content-end align-items-center" id="navbarSupportedContent">
						    <ul class="navbar-nav">
								...
								<li><a href="<?php echo site_url() ?>/welcome/diagnosa">Beranda</a></li> 
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<section class="login100-form validate-form">
					<span class="login100-form-title p-b-10" style="font-family: arial">
						Selamat Datang Di Sistem Diagnosa Penyakit Asma
						<p></p>
						<span style="text-align: center !important; font-size: 18px; text-transform: none;">Silahkan login untuk melanjutkan</span>
					</span>
					...
					<div class="wrap-input100 rs1-wrap-input100 validate-input m-b-20" data-validate="Type username">
						...
						<span class="focus-input100" style="border-color: #blue"></span>
					</div>
				...
				<div class="login100-more" style="background-image: url('<?php echo base_url() ?>assets/templatelogin/images/isi/isi-2.jpg');"></div>
			</div>
		</div>
	</div>
