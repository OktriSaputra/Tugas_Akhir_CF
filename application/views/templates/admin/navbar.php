          ...
          <div class="left_col scroll-view" style="background: #fff">
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                <h1 style="color: #00008B"><b>Selamat Datang</b></h1>
                <h3 style="color: #4B6277">Sistem Diagnosa Penyakit Asma</h3>
              </div>
            </div>
            <!-- /menu profile quick info -->
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a style="color: #2F4356"><i class="fa fa-list"></i> Data Gejala <span class="fa fa-chevron-down" style="color: #2F4356"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="<?php echo site_url() ?>/nilai_cf" style="color: #2F4356">Aturan</a></li>
                    </ul>
                  </li>
            ...
            <div class="sidebar-footer hidden-small" style="background: #EDEDED ">
              ...
              ?>
                  <a data-toggle="tooltip" data-placement="top" title="Logout" href="<?php echo site_url() ?>/login_admin/logout" style="width: 100%; background: #fff;">
